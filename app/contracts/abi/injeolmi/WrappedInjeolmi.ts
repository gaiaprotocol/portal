...
export interface WrappedInjeolmiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PERMIT_TYPEHASH"
...
export interface WrappedInjeolmi extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedInjeolmi;
  waitForDeployment(): Promise<this>;

  interface: WrappedInjeolmiInterface;
