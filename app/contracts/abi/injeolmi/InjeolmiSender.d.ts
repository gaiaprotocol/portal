...
interface InjeolmiSenderInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "injeolmi", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "injeolmi", data: BytesLike): Result;
...
export class InjeolmiSender extends Contract {
  ...
  interface: InjeolmiSenderInterface;
  ...
  functions: {
    ...
    injeolmi(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    injeolmi(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    injeolmi(overrides?: CallOverrides): Promise<PopulatedTransaction>;
