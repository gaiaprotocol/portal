...
export interface InjeolmiSenderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "receiveOverHorizon"
      | "received"
...
export interface InjeolmiSender extends BaseContract {
  connect(runner?: ContractRunner | null): InjeolmiSender;
  ...
  injeolmi: TypedContractMethod<[], [string], "view">;
